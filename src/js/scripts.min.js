...
function openMenu() {
  var element = document.querySelectorAll(".main-menu-footer");
...
function closeMenu() {
  var close = document.querySelectorAll(".main-menu-footer");
...
document.addEventListener('DOMContentLoaded', function() {
  var menuModal = document.querySelector('.main-menu-footer');
  var menuItems = document.querySelectorAll('.main-menu-footer .item');
